...
Для версий Windows выпущенных до Windows 10 необходимо использовать [Docker Toolbox](https://www.docker.com/products/docker-toolbox) и выполнить дполнительную настройку:
