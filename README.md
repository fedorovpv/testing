...
- В секции "шаги" описан тестовый сценарий, но, возможно, поведение тестируемой системы отличается от ожидаемого. Анализ отличия не входит в задание, но всегда приветствуется.
